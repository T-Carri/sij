...
<div className='flex row items-end justify-start gap-10 mt-2'>
    <h2 className="mt-2 text-lg font-medium sm:text-xl">
      <a href="" className="hover:underline"> Agrega ST </a>
    </h2>
  </div>
...
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-10 w-10 transform rotate-90" // Rotamos el icono -90 grados
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth="2"
